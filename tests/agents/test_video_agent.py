...
class TestVideoAgent:
    ...
    def test_initialization(self, mock_claude_client, mock_search_tools):
        ...
        agent = VideoAgent(mock_claude_client, mock_search_tools)
    ...
    def test_execute_success(self, mock_claude_client, mock_search_tools, sample_agent_task, mock_video_results):
    ...
    def test_execute_no_videos_found(self, mock_claude_client, mock_search_tools, sample_agent_task):
    ...
    def test_execute_claude_failure_fallback(self, mock_claude_client, mock_search_tools, sample_agent_task, mock_video_results):
        """Test fallback to first video when Claude fails."""
        mock_search_tools.search_youtube_videos.return_value = mock_video_results
        mock_claude_client.simple_query.side_effect = Exception("API Error")
    ...
    def test_parse_choice_valid(self, mock_claude_client, mock_search_tools):
        """Test parsing valid choice from Claude response."""
        agent = VideoAgent(mock_claude_client, mock_search_tools)
    ...
    def test_parse_choice_out_of_bounds(self, mock_claude_client, mock_search_tools):
    ...
    def test_parse_choice_invalid_format(self, mock_claude_client, mock_search_tools):
    ...
    def test_parse_reasoning_valid(self, mock_claude_client, mock_search_tools):
    ...
    def test_parse_reasoning_missing(self, mock_claude_client, mock_search_tools):
    ...
    def test_run_with_error_handling(self, mock_claude_client, mock_search_tools, sample_agent_task):
